...
def leaving_quietly():
    ...
    arp_response.hwdst = "00:50:56:ef:bc:68"  # Router's MAC address
    
    # Set the real MAC address of the victim (so the router learns the correct binding)
    arp_response.hwsrc = "00:0c:29:6b:b0:e3"  # Victim's MAC address
    
    # Set the victim's IP address as the source IP
    arp_response.psrc = "192.168.1.129"  # Victim's IP address
